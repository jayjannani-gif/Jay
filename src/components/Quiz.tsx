    ...
    >
      ...
      <div className="relative z-10">
        <div className="flex items-center gap-2 mb-6" id="quiz-header-badge">
          ...
          <span className="text-xs font-sans font-semibold uppercase tracking-wider bg-linear-to-r from-blue-400 via-purple-400 to-rose-400 bg-clip-text text-transparent">
            AI Discovery Studio
          </span>
        </div>
